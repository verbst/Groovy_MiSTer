...
2) Copy core "GroovyNLC_20260822.rbf" to /media/fat/_Utility
...
.rbf filename - the rbf can be called anything. Because the core name also keys
the OSD settings file, the input maps and the game dir, carry them over once:
